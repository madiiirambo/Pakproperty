<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Support.aspx.cs" Inherits="PakProperty.Support" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                  <a href="userUpdateInfo.aspx">     <asp:Label ID="Label1" ForeColor="Red" Font-Bold="true" Font-Size="Large" runat="server" Text="An Auto Generated Email or Text Message would be recieved on your saved Contact Information, Furthermore our Representative would contact you shortly to solve your query. To update your Contact Information CLICK HERE"></asp:Label> </a>
 ...
 <div class="row">
                                        ...
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                ...
                                                <asp:TextBox ID="email" ReadOnly="true" ForeColor="Black" Font-Bold="true" runat="server" class="validate"></asp:TextBox>
                                                <label>User Email Address</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">phone</i>
                                                <asp:TextBox ID="phone" class="validate" ReadOnly="true" ForeColor="Black" Font-Bold="true" runat="server"></asp:TextBox>
                                ...
                                <div class="card-content">
                                    ...
                                    <asp:Button ID="Button1" OnClick="sendMessage" class="btn btn-success" runat="server" Text="Send Message" />
