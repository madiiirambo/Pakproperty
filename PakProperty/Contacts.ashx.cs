...
namespace PakProperty
{
    ...
    public class Contacts : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("spGetContacts", con);
                ...
                while (rdr.Read())
                {
                    Contact part = new Contact();
                    part.id = Convert.ToInt32(rdr["id"]);
                    filteredCount = Convert.ToInt32(rdr["TotalCount"]);
                    part.number = rdr["number"].ToString();
        ...
        private int GetPartnerTotalCount()
        {
            ...
            {
                SqlCommand cmd = new
                    SqlCommand("select count(*) from tblContacts", con);
                con.Open();
