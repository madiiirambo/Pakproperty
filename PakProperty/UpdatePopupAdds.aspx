<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePopupAdds.aspx.cs" Inherits="PakProperty.UpdatePopupAdds" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field form-input col s6">
                                                ...
                                                <asp:TextBox   ID="Pname" runat="server"></asp:TextBox>
                                                 <label for="Pname">Popup Adds Name</label>
                                            </div>
                                    </div>
                                </div>
                                <!--File UPLOAD-->
