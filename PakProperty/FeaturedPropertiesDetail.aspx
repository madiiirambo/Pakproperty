<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeaturedPropertiesDetail.aspx.cs" Inherits="PakProperty.FeaturedPropertiesDetail" %>
        ...
        <div class="container">
            ...
            <div action="#" id="bloq-search" class="collapse">
                <div class="bloq-search">
                    <asp:TextBox ID="TextBox1" placeholder="search by property ID" runat="server"></asp:TextBox>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12 blog-pots">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-10 cod-pad">
                            <div class="sorting-options">
                                <h5><span>Price:</span> Rs : <asp:Label ID="Minprice" runat="server" Font-Bold="true" ForeColor="Blue"></asp:Label> - <asp:Label ID="Maxprice" Font-Bold="true" runat="server" ForeColor="Blue"></asp:Label></h5>
                            ...
                            <div class="homes-content details-2 mb-5">
                                ...
                                <ul class="homes-list clearfix">
                                    <li>
                                        ...
                                        <span>Bed <%# Eval("propertyBeds") %> </span>
                                    </li>
                                    <li>
                                        <i class="fa fa-bath" aria-hidden="true"></i>
                                        <span>Baths <%# Eval("propertyBaths") %></span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <span>Garages <%# Eval("propertyGarage") %></span>
                                    </li>
                                    <li>
                                        <i class="fa fa-columns" aria-hidden="true"></i>
                                        <span>Kitchen <%# Eval("propertyKitchen") %></span>
                                    </li>
                                    <li>
                                        <i class="fa fa-clone" aria-hidden="true"></i>
                                        <span>Balcony <%# Eval("propertyBalcony") %></span>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="homes-content details mb-5">
                    <!-- title -->
                    <h5 class="mb-4">Project Types</h5>
                    <!-- cars List -->

                    <asp:Repeater ID="rptType" runat="server" >
                                        <ItemTemplate> 

                    <div class="row homes-list clearfix">
                        <div class="col-md-2">
                            <h4> <span><%# Eval("fsname") %></span></h4>
                        </div>

                        <div class="col-md-4">
                            <i class="fa fa-building" aria-hidden="true">
                            </i>
                            <span>Area: </span> <span> <%# Eval("minsq") %> - <%# Eval("maxsq") %></span>
                        </div>
                        <div class="col-md-6">
                            <i class="fa fa-tag" aria-hidden="true">
                            </i>
                            <span>Price: </span><span> PKR <%# Eval("min") %> - <%# Eval("max") %></span>
                        </div>
                        <br>
                        <br>
                    </div>
                ...
                <div class="homes-content details mb-5">
                    <!-- title -->
                    <h5 class="mb-4">Project Features</h5>
                    <!-- cars List -->
                    <ul class="homes-list clearfix">
                ...
                <div class="property-location mb-5">
                    <h5>Payment Plans</h5>
                    <h6><i class="fa fa-download"></i> &nbsp; Right Click to Save As to download the Payment plan Image</h6>
                    <br>
                    <div class="payment_plans_img">

                        <asp:Repeater ID="rptppImg" runat="server" >
                                        <ItemTemplate>
                    ...
                    <div class="container">
                        ...
                        <div class="row team-all">
                            ...
                            <div class="col-lg-4 col-md-6 team-pro hover-effect">
                                <div class="team-wrap">
                                    <div class="team-img">
                                        <img src="<%# Eval("agentimg") %>" alt=""/>
                                    </div>
                                    <div class="team-content">
                                        <div class="team-info">
                                            <h3><%# Eval("agentname") %></h3>
                                            
                                            <div class="team-socials">
                                                <ul>
                                                    <li>
                                                        <a target="_blank" href="<%# Eval("agentfblink") %>" title="facebook"><i class="fa fa-facebook" 
                                                                                        aria-hidden="true"></i></a>

                                                    </li>
                                                </ul>
                                            </div>
                                            <span><%# Eval("agentmob") %></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="widget">
                    ...
                    <div action="">
                        <div class="form-group">
                            <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Name:" Font-Size="Large"></asp:Label>
                            
                            <asp:Label ID="bname" runat="server" Font-Bold="true"  Font-Size="Large"></asp:Label>
                            <i class="icon_name_alt"></i>
                        </div>
                        <br /> 
                        <div class="form-group">
                            <asp:Label ID="Label2" runat="server" Font-Bold="true" Text="Address:" Font-Size="Large"></asp:Label>
                         <asp:Label ID="baddress" runat="server" Font-Bold="true"  Font-Size="Large" ></asp:Label>
                            <i class="icon_mail_alt"></i>
                        </div>
                        <br /> 
                        <div class="form-group">
                            <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="Phone:" Font-Size="Large"></asp:Label>
                        ...
                        <br /> 
                       <div class="form-group">
                             <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Phone:" Font-Size="Large"></asp:Label>
                           <asp:Label ID="bnum1" runat="server" Font-Bold="true"  Font-Size="Large" ></asp:Label>
                            <i class="icon_phone_alt"></i>
                        </div>
                        <br /> 

                        <div class="form-group">
                             <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Phone:" Font-Size="Large"></asp:Label>
                           <asp:Label ID="bnum2" runat="server" Font-Bold="true"  Font-Size="Large"></asp:Label>
                            <i class="icon_phone_alt"></i>
                        </div>
