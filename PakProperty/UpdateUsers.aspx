<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUsers.aspx.cs" Inherits="PakProperty.UpdateUsers" %>
...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="ViewPartners.aspx">View Advertisement</a></li>
            ...
            <section class="content-header z-depth-1">
                ...
                <div class="header-title">
                    ...
                    <ul class="link hidden-xs">
                        ...
                        <li><a href="ViewUsers.aspx">View Users</a></li>
                        <li><a href="UpdateUsers.aspx">Update User</a></li>
 ...
 <div class="row">
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="nametxt" runat="server" class="validate"></asp:TextBox>
                                                <label>User Name</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="emailtxt" class="validate" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="pass" runat="server" class="validate"></asp:TextBox>
                                                <label> Password</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="con" class="validate" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="phone" TextMode="Number" runat="server" class="validate"></asp:TextBox>
                                                <label> User Phone</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="text" class="validate"  runat="server"></asp:TextBox>
                                            ...
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="free" TextMode="Number" runat="server" class="validate"></asp:TextBox>
                                                <label>Free Adds</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="gold" class="validate" TextMode="Number"  runat="server"></asp:TextBox>
                                                <label>Gold Adds</label>
                                            </div>
                                                                                        </div>
                                            ...
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="diamond" TextMode="Number" runat="server" class="validate"></asp:TextBox>
                                                <label>Diamond Adds</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="indgold" class="validate" TextMode="Number"  runat="server"></asp:TextBox>
                                                <label>Individual Gold Adds</label>
                                            </div>
                                                                                                                              <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="inddia" class="validate" TextMode="Number"  runat="server"></asp:TextBox>
                                                <label>Individual Diamond Adds</label>
                                            </div>
