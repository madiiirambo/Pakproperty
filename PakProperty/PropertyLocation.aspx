<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropertyLocation.aspx.cs" Inherits="PakProperty.PropertyLocation" %>
  ...
  <body>
    ...
    <div id="infowindow-content">
      ...
      <form runat="server">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <asp:Button ID="go" runat="server" OnClick="details" Text="Click To Further Information" />
          <br />

          <asp:TextBox id="latitude" Width="-0"  runat="server"></asp:TextBox>
          <asp:TextBox id="longitude" Width="-0"  runat="server"></asp:TextBox>
          <asp:TextBox id="add" Width="-0"  runat="server"></asp:TextBox>
