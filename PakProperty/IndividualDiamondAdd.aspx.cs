...
{
    public partial class IndividualDiamondAdd : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        {
            SqlCommand cmd = new SqlCommand("update tblUsersData set inddia=inddia-1 where userId=@userId", con);
