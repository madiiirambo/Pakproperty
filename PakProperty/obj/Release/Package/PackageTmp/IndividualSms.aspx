<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndividualSms.aspx.cs" Inherits="PakProperty.IndividualSms" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <asp:Label ID="mm" ForeColor="Red" Font-Bold="true" Font-Size="Large" runat="server"></asp:Label> 
                                    <br />
                                    <div class="row">
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">phone</i>
                                                <asp:TextBox ID="number" onkeydown="return (!(event.keyCode>=65 && event.keyCode<=90 ) && event.keyCode!=32);" runat="server"></asp:TextBox>
                                                <label for="icon_prefix">Enter Number</label>
                                            </div>
...
<i class="material-icons prefix">feedback</i>
                                                <asp:TextBox ID="msg" TextMode="MultiLine" Width="800" Height="200" runat="server" class="autocomplete" ></asp:TextBox>
                                                
                                                <label for="icon_prefix">Enter Message</label>
                                            </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <asp:Button ID="button" OnClick="sendSms"  class="btn btn-success" runat="server"  Text="Send Message" />
