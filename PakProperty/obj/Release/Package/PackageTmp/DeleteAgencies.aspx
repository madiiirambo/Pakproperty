<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteAgencies.aspx.cs" Inherits="PakProperty.DeleteAgencies" %>
<!DOCTYPE html>
            ...
            <section class="content-header z-depth-1">
                ...
                <div class="header-title">
                    ...
                    <ul class="link hidden-xs">
                        ...
                        <li><a href="UpdateAgencies.aspx">Update Agencies</a></li>
                                    ...
                                    <div class="row">
                                        <div  class="col s12 m-t-20">
                                            ...
                                            <div class="input-field form-input col s6">
                                                ...
                                                <asp:TextBox ID="text"  ForeColor="Black"  Font-Bold="true" class="validate" runat="server"></asp:TextBox>
                                                <label>City</label>
                                            </div>
                                            ...
                                            <div class="input-field form-input col s6">
                                                 ...
                                                 <br>
             <asp:Button ID="Button1" class="btn btn-success" OnClick="delte"  runat="server" Text="Delete" />
