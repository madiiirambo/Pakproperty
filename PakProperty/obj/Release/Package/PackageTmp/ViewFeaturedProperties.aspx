<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFeaturedProperties.aspx.cs" Inherits="PakProperty.ViewFeaturedProperties" %>
                            ...
                            <div class="card-content">
                                ...
                                <table class="responsive-table highlight bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="Status">Update Property Basic Info</th>
                                        <th data-field="Status">Update Property Features</th>
                                        <th data-field="Status">Update Property Location</th>
                                        <th data-field="Status">Update Property Booking Office</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="AddFeaturedProperty.aspx?id=del <%# Eval("propertyId") %>">
                                            ...
                                            <td>
                                            <a href="UpdateFeaturedPropertiesBasicInfo.aspx?id=<%# Eval("propertyId") %>">
                                          ...
                                          <td>
                                            <a href="UpdateFeaturedPropertiesFeatures.aspx?id=<%# Eval("propertyId") %>">
                                                    <button class="btn btn-sm" data-toggle="tooltip"
                                                            data-placement="left"
                                                            title="Update"><i class="fa fa-pencil"
                                                                              aria-hidden="true"></i>
                                          ...
                                          <td>
                                            <a href="UpdateFeaturedPropertiesLocation.aspx?id=<%# Eval("propertyId") %>">
                                                    <button class="btn btn-sm" data-toggle="tooltip"
                                                            data-placement="left"
                                                            title="Update"><i class="fa fa-pencil"
                                                                              aria-hidden="true"></i>
                                          ...
                                          <td>
                                            <a href="UpdateFeaturedPropertiesOffice.aspx?id=<%# Eval("propertyId") %>">
                                                    <button class="btn btn-sm" data-toggle="tooltip"
                                                            data-placement="left"
                                                            title="Update"><i class="fa fa-pencil"
                                                                              aria-hidden="true"></i>
