<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordChange.aspx.cs" Inherits="PakProperty.PasswordChange" %>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                ...
                                                <asp:TextBox ID="prepass" runat="server"></asp:TextBox>
                                ...
                                <div class="card-content">
                                    ...
                                    <asp:Button ID="Button1" OnClick="changepass"  class="btn btn-success" runat="server"  Text="Submit" />
