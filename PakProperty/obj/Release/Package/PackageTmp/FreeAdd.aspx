<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreeAdd.aspx.cs" Inherits="PakProperty.FreeAdd" %>
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        <div  class="col s12 m-t-20">
                                                ...
                                                <div class="select-wrapper icons">
                                                    ...
                                                    <asp:DropDownList class="icons initialized" ID="ddcities" runat="server">
                                                        ...
                                                        <asp:ListItem Text="Hyderabad" Value="7"></asp:ListItem>
                                                         <asp:ListItem Text="Rawaloindi" Value="8"></asp:ListItem>
                                            ...
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">business</i>
                                                <asp:TextBox ID="typeaddTxt" ReadOnly="true" Text="Free" ForeColor="Black" Font-Bold="true" class="validate" runat="server"></asp:TextBox>
                                                <label>Property Type</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">business</i>
                                                <asp:TextBox ID="expireDate" ReadOnly="true" Text="1 Month" ForeColor="Black" Font-Bold="true" class="validate" runat="server"></asp:TextBox>
