<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndividualDiamondAdd.aspx.cs" Inherits="PakProperty.IndividualDiamondAdd" %>
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        <div  class="col s12 m-t-20">
                                            ...
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">business</i>
                                                <asp:TextBox ID="typeaddTxt" ReadOnly="true" Text="Diamond" ForeColor="Black" Font-Bold="true" class="validate" runat="server"></asp:TextBox>
                                                <label>Property Type</label>
                                            </div>

                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">business</i>
                                                <asp:TextBox ID="expireDate" ReadOnly="true" Text="1 Week" ForeColor="Black" Font-Bold="true" class="validate" runat="server"></asp:TextBox>
