<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteAdvertisement.aspx.cs" Inherits="PakProperty.DeleteAdvertisement" %>
            ...
            <section class="content-header z-depth-1">
                ...
                <div class="header-title">
                    ...
                    <ul class="link hidden-xs">
                        ...
                        <li><a href="UpdateAdvertisement.aspx">Update Advertisement</a></li>
                        <li><a href="DeleteAdvertisement.aspx">Delete Advertisement</a></li>
                    </ul>
                </div>
            </section>
            <!-- page section -->
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                            ...
                                            <asp:TextBox ID="Pid" runat="server" onkeydown="return (!(event.keyCode>=65 && event.keyCode<=90 ) && event.keyCode!=32);"></asp:TextBox>
                                                ...
                                                <label for="Pid">Advertisement Id</label>
                                            </div>
                                        ...
                                        <div class="col s12 m-t-20">
                                            <div class="input-field form-input col s6">
                                                ...
                                                <label for="icon_prefix">Advertisement Name</label>
                                            </div>
                                            <div class="input-field form-input col s6">
                                                <i class="material-icons prefix">account_circle</i>
                                                <asp:TextBox ID="link" runat="server"></asp:TextBox>
                                                <label for="icon_prefix">Advertisement Link</label>
                                            </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <br>
                                    <asp:Button ID="Button1" OnClick="delete"  class="btn btn-success" runat="server"  Text="Delete" />
