<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgetPass.aspx.cs" Inherits="PakProperty.forgetPass" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
	...
	<section id="forget" class="headings">
		<div class="text-heading text-center">
			<div class="container">
				<h1>Forget Password</h1>
				<h2><a href="index.aspx">Home </a> &nbsp;/&nbsp; Forget Password</h2>
			</div>
		</div>
	</section>
	...
	<div id="login">
		<div class="login">
			<div method="post" >
				...
				<div  class="form-group">
					<label>Enter Your Register Phone Number</label>
                        <asp:TextBox ID="num" onkeydown="return (!(event.keyCode>=65 && event.keyCode<=90 ) && event.keyCode!=32);" class="form-control" TabIndex="2" runat="server"></asp:TextBox>
                    <asp:Label ID="lblcheck" ForeColor="Red" runat="server" Text="Label"></asp:Label>
					<i class="icon_lock_alt"></i>
				</div>
				
                <asp:Button  ID="btn" OnClick="sendEmail"  class="btn_1 rounded full-width" runat="server" Text="Forget Password" />
