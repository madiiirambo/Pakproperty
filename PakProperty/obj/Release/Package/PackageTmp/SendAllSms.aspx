<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendAllSms.aspx.cs" Inherits="PakProperty.SendAllSms" %>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="select-wrapper icons">
                                                    ...
                                                    <asp:DropDownList class="icons initialized" ID="ddcontacts" AutoPostBack="true"  OnSelectedIndexChanged="totalNum" runat="server">
