<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agents.aspx.cs" Inherits="PakProperty.Agents" %>
...
<head>
	...
	<title>Agents Listing Grid</title>
	<!-- FAVICON -->
...
<body class="inner-pages">
	...
	<section class="headings">
		<div class="text-heading text-center">
			<div class="container">
				<h1> Our Agents</h1>
				<h2><a href="Index.aspx">Home </a> &nbsp;/&nbsp; Agents</h2>
			</div>
		</div>
	</section>
	...
	<div class="partners">
		<div class="container">
			...
			<div class="owl-carousel style2">
				...
				<a href="AgentDetails.aspx?id= <%# Eval("agencyId") %>"><div class="owl-item" ><img src="<%# Eval("image") %>" alt=""></div></a>
                                            </ItemTemplate>
                </asp:Repeater>
			</div>
