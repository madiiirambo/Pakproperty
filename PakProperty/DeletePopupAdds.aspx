<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeletePopupAdds.aspx.cs" Inherits="PakProperty.DeletePopupAdds" %>
        ...
        <div class="page-content">
            ...
            <section class="content-header z-depth-1">
                ...
                <div class="header-title">
                    <h1> Delete Popup Adds </h1>
                    <small></small>
                    <ul class="link hidden-xs">
                       <li><a href="Dashboard.aspx"><i class="fa fa-home"></i>Dashboard</a></li>
                       <li><a href="ViewPopup.aspx">View Popup Adds</a></li>
                        <li><a href="UpdatePopupAdds.aspx">Update Popup Adds</a></li>
                        <li><a href="DeletePopupAdds.aspx">Delete Popup Adds</a></li>
                    </ul>
                </div>
            </section>
            <!-- page section -->
                                    ...
                                    <div class="row">
                                        <div class="col s12 m-t-20">
                                            ...
                                            <asp:TextBox ID="Pid" runat="server" onkeydown="return (!(event.keyCode>=65 && event.keyCode<=90 ) && event.keyCode!=32);"></asp:TextBox>
                                                ...
                                                <label for="Pid">Popup Add Id</label>
                                            </div>
                                        ...
                                        <div class="input-field form-input col s6">
                                                ...
                                                <asp:TextBox   ID="Pname" runat="server"></asp:TextBox>
                                                 <label for="Pname">Popup Add Name</label>
                                            </div>
                                    </div>
                                    <asp:Button ID="Button1" class="btn btn-success" runat="server" OnClick="delete" Text="Delete" />
