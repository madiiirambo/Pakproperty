<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFeaturedPropertiesAgents.aspx.cs" Inherits="PakProperty.ViewFeaturedPropertiesAgents" %>
        ...
        <div class="page-content">
            ...
            <section class="content-header z-depth-1">
                ...
                <div class="header-title">
                    <h1> Featured Properties Agents </h1>
                    <small></small>
                    ...
                    <!-- bootstrap table -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h2>Featured Properties Agents</h2>
                            </div>
                            <div class="card-content">
                                ...
                                <table class="responsive-table highlight bordered">
                                    <thead>
                                        ...
                                        <th data-field="id">Agent Id</th>
                                        <th data-field="id">Agent Name</th>
                                        <th data-field="name">Agent Contact</th>
                                        <th data-field="id">Agent Facebook Link</th>
                                        <th data-field="id">Update Agent</th>
                                        <th data-field="id">View Property</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><%# Eval("agentmob") %></td>
                                        <td><%# Eval("agentfblink") %></td>
                                        
                                        
                                        
                                            <td>
                                            <a href="UpdateFeaturedPropertiesAgent.aspx?id=<%# Eval("id") %>">
                                             ...
                                             <td>
                                            <a target="_blank" href="FeaturedPropertiesDetail.aspx?id=<%# Eval("propertyId") %>">
                                                    <button class="btn btn-sm" data-toggle="tooltip"
                                                            data-placement="left"
