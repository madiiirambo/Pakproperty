...
{
    public partial class DiamondAdd : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        public void diamondAddupdate(int id)
        {
            SqlCommand cmd = new SqlCommand("update tblUsersData set diamond=diamond-1 where userId=@userId", con);
        ...
        {
            SqlCommand cmd = new SqlCommand("UPDATE tblAdds set expdate=(DateADD(YEAR,1,expdate)) WHERE propertyId=@propertyId", con);
